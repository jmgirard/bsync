...
> **Note on Parameter Selection:** Selecting the right window size and lag parameters is critical for a valid analysis. Before running your own data, we highly recommend reading the `vignette("wcc-params")` guide to learn how to use the `suggest_wcc_params()` helper function.
