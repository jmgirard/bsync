...
that match analysis hyperparameters to your signal’s own timescales.
...
Next, we calculate the windowed cross-correlations. Calling
[`summary()`](https://rdrr.io/r/base/summary.html) on the resulting
object provides a clean, formatted overview of the analysis settings and
